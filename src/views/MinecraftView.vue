<template>
	<header class="text-center p-8 space-y-4">
		<h1 class="text-5xl font-bold">Jouer à Minecraft</h1>
		<p>Vous pouvez jouer à minecraft en <u>1.12.2</u> sur un serveur 100% dédié aux MMI de Vélizy.</p>
	...
	<main class="text-center py-8 space-y-8 md:w-2/3 md:mx-auto lg:w-1/2">
		...
		<section class="px-8 space-y-4">
			...
			<p><b>Choisissez bien votre pseudo</b>, c'est lui qui vous permettra de sauvegarder votre progression.</p>
		</section>
	</main>
</template>
