...
<template>
	<main id="settingsMenu" class="hidden fixed top-0 bg-slate-50/50 w-screen h-screen overflow-y-auto duration-150 max-md:w-full max-sm:p-4 sm:p-8 md:p-24 md:px-0">
		<div class="select-none text-slate-800 bg-slate-50/40 backdrop-blur-md border-2 border-slate-50/20 rounded-3xl shadow-2xl p-8 space-y-6 md:p-8 md:m-auto md:w-2/3 lg:w-1/2 2xl:w-2/5">
			...
			<section class="bg-cyan-600/15 text-cyan-600 text-sm rounded-lg px-4 py-3">
				<strong>INFO:</strong> Ces paramètres sont stockés dans votre navigateur et ne sont envoyés sur aucun serveur tiers.
			</section>
